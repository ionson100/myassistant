package com.settings.ion.mylibrary.colorpicker;
...
import com.settings.ion.mylibrary.R;
import com.settings.ion.mylibrary.colorpicker.builder.ColorWheelRendererBuilder;
import com.settings.ion.mylibrary.colorpicker.builder.PaintBuilder;
import com.settings.ion.mylibrary.colorpicker.renderer.ColorWheelRenderOption;
import com.settings.ion.mylibrary.colorpicker.renderer.ColorWheelRenderer;
import com.settings.ion.mylibrary.colorpicker.slider.AlphaSlider;
import com.settings.ion.mylibrary.colorpicker.slider.LightnessSlider;
...
public class ColorPickerView extends View {
	...
	private ColorCircle findNearestByColor(int color) {
		...
		for (com.settings.ion.mylibrary.colorpicker.ColorCircle colorCircle : renderer.getColorCircleList()) {
