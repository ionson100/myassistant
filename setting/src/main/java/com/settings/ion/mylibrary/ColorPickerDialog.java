...
class ColorPickerDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(attribute.settingField.title());
    ...
    private static class ColorPickerView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (Color.red(mCurrentColor) + Color.green(mCurrentColor) + Color.blue(mCurrentColor) < 384)
                ...
                mPaint.setColor(Color.BLACK);
            canvas.drawText(getResources().getString(R.string.save), 74, 340, mPaint);
            ...
            if (Color.red(mDefaultColor) + Color.green(mDefaultColor) + Color.blue(mDefaultColor) < 384)
                ...
                mPaint.setColor(Color.BLACK);
            canvas.drawText(getResources().getString(R.string.default_color_confirm), 202, 340, mPaint);
        }
