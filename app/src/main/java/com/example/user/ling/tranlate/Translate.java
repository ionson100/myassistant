...
public final class Translate extends YandexTranslatorAPI {
    ...
    public static String execute(final String text, final Language from, final Language to, Activity activity, IAction iAction) throws Exception {
        ...
        return retrievePropArrString(url, TRANSLATION_LABEL,activity,iAction).trim();
    }
}
